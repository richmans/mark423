...
class PrivilegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privilege" do
    assert_difference("Privilege.count") do
      post privileges_url, params: { privilege: { podcast_id: @privilege.podcast_id, role: @privilege.role, user_id: @privilege.user_id } }
    end
  ...
  test "should update privilege" do
    patch privilege_url(@privilege), params: { privilege: { podcast_id: @privilege.podcast_id, role: @privilege.role, user_id: @privilege.user_id } }
